...
void hgemm_batch(cl::sycl::queue &queue, MKL_LAYOUT layout, MKL_TRANSPOSE transa,
                 MKL_TRANSPOSE transb, int64_t m, int64_t n, int64_t k, cl::sycl::half alpha,
                 cl::sycl::buffer<cl::sycl::half, 1> &a, int64_t lda, int64_t stride_a,
                 cl::sycl::buffer<cl::sycl::half, 1> &b, int64_t ldb, int64_t stride_b,
                 cl::sycl::half beta, cl::sycl::buffer<cl::sycl::half, 1> &c, int64_t ldc,
                 int64_t stride_c, int64_t batch_size, int64_t offset_a = 0, int64_t offset_b = 0,
                 int64_t offset_c = 0);
...
cl::sycl::event hgemm_sycl(cl::sycl::queue *queue, MKL_LAYOUT layout, MKL_TRANSPOSE transa,
                           MKL_TRANSPOSE transb, int64_t m, int64_t n, int64_t k,
                           cl::sycl::half alpha, const cl::sycl::half *a, int64_t lda,
                           const cl::sycl::half *b, int64_t ldb, cl::sycl::half beta,
                           cl::sycl::half *c, int64_t ldc,
                           const std::vector<cl::sycl::event> &dependencies, int64_t offset_a = 0,
                           int64_t offset_b = 0, int64_t offset_c = 0);

cl::sycl::event gemm_f16f16f32_sycl(cl::sycl::queue *queue, MKL_LAYOUT layout, MKL_TRANSPOSE transa,
                                    MKL_TRANSPOSE transb, int64_t m, int64_t n, int64_t k,
                                    float alpha, const cl::sycl::half *a, int64_t lda,
                                    const cl::sycl::half *b, int64_t ldb, float beta, float *c,
...
cl::sycl::event hgemm_batch_sycl(cl::sycl::queue *queue, MKL_LAYOUT layout, MKL_TRANSPOSE transa,
                                 MKL_TRANSPOSE transb, int64_t m, int64_t n, int64_t k,
                                 cl::sycl::half alpha, const cl::sycl::half *a, int64_t lda,
                                 int64_t strideA, const cl::sycl::half *b, int64_t ldb,
                                 int64_t strideB, cl::sycl::half beta, cl::sycl::half *c,
                                 int64_t ldc, int64_t strideC, int64_t groupsize,
                                 const std::vector<cl::sycl::event> &dependencies,
                                 int64_t offset_a = 0, int64_t offset_b = 0, int64_t offset_c = 0);
...
cl::sycl::event hgemm_batch_sycl(cl::sycl::queue *queue, MKL_LAYOUT layout, MKL_TRANSPOSE transa,
                                 ...
                                 cl::sycl::half alpha, const cl::sycl::half **a, int64_t lda,
                                 const cl::sycl::half **b, int64_t ldb, cl::sycl::half beta,
                                 cl::sycl::half **c, int64_t ldc, int64_t offset_batch,
                                 int64_t groupsize,
                                 const std::vector<cl::sycl::event> &dependencies,
                                 int64_t offset_a = 0, int64_t offset_b = 0, int64_t offset_c = 0);
