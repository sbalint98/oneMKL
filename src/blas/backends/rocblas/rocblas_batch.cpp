...
GEMM_STRIDED_BATCH_LAUNCHER(half, rocblas_hgemm_strided_batched)
...
GEMM_STRIDED_BATCH_LAUNCHER_USM(half, rocblas_hgemm_strided_batched)
...
GEMM_BATCH_LAUNCHER_USM(half, rocblas_hgemm_batched)
