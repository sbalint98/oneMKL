...
cl::sycl::event gemm(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                     std::int64_t n, std::int64_t k, float alpha, const cl::sycl::half *a,
                     std::int64_t lda, const cl::sycl::half *b, std::int64_t ldb, float beta,
...
cl::sycl::event gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb,
                           std::int64_t m, std::int64_t n, std::int64_t k, cl::sycl::half alpha,
                           const cl::sycl::half *a, std::int64_t lda, std::int64_t stride_a,
                           const cl::sycl::half *b, std::int64_t ldb, std::int64_t stride_b,
                           cl::sycl::half beta, cl::sycl::half *c, std::int64_t ldc,
                           std::int64_t stride_c, std::int64_t batch_size,
                           const std::vector<cl::sycl::event> &dependencies = {});
