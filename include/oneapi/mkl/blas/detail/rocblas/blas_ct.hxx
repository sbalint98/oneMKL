...
void herk(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::blas::rocblas::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                           lda, beta, c, ldc);
...
void scal(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
void scal(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
void scal(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<float> alpha,
...
void scal(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<double> alpha,
...
void spr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
...
void spr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, double alpha,
...
void syrk(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::blas::rocblas::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                           lda, beta, c, ldc);
...
void her2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void hbmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void rot(backend_selector<backend::rocblas> selector, std::int64_t n,
         cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
void rot(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void rot(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void axpy(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
void axpy(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
void axpy(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<float> alpha,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy) {
    axpy_precondition(selector.get_queue(), n, alpha, x, incx, y, incy);
    oneapi::mkl::blas::rocblas::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy);
...
void axpy(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<double> alpha,
          cl::sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
...
void axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
void axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
void axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t n,
...
void axpby(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
    ...
    oneapi::mkl::blas::rocblas::MAJOR::axpby(selector.get_queue(), n, alpha, x, incx, beta, y, incy);
    axpby_postcondition(selector.get_queue(), n, alpha, x, incx, beta, y, incy);
}

void axpby(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
void axpby(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<float> alpha,
...
void axpby(backend_selector<backend::rocblas> selector, std::int64_t n, std::complex<double> alpha,
           cl::sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
           std::complex<double> beta, cl::sycl::buffer<std::complex<double>, 1> &y,
           std::int64_t incy) {
    axpby_precondition(selector.get_queue(), n, alpha, x, incx, beta, y, incy);
...
void sdsdot(backend_selector<backend::rocblas> selector, std::int64_t n, float sb,
            cl::sycl::buffer<float, 1> &x, std::int64_t incx, cl::sycl::buffer<float, 1> &y,
            std::int64_t incy, cl::sycl::buffer<float, 1> &result) {
    sdsdot_precondition(selector.get_queue(), n, sb, x, incx, y, incy, result);
    oneapi::mkl::blas::rocblas::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result);
    sdsdot_postcondition(selector.get_queue(), n, sb, x, incx, y, incy, result);
}

void gerc(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n,
          std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda) {
...
void gemv(backend_selector<backend::rocblas> selector, transpose trans, std::int64_t m,
...
void gemv_batch(backend_selector<backend::rocblas> selector, transpose trans, std::int64_t m,
                std::int64_t n, float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
...
void dgmm_batch(backend_selector<backend::rocblas> selector, side left_right, std::int64_t m,
...
void her(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
         cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
         cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda) {
...
void her(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, double alpha,
         cl::sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
         cl::sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda) {
    her_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
    oneapi::mkl::blas::rocblas::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
...
void hpr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
         cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
void hpr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, double alpha,
         cl::sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
...
void iamin(backend_selector<backend::rocblas> selector, std::int64_t n,
           cl::sycl::buffer<float, 1> &x, std::int64_t incx,
...
void hpmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void spmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
...
void spmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void gemm_bias(backend_selector<backend::rocblas> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::blas::rocblas::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n,
...
void swap(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void swap(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<double, 1> &x, std::int64_t incx, cl::sycl::buffer<double, 1> &y,
          std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::blas::rocblas::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
...
void geru(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n,
          std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda) {
...
void nrm2(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
void nrm2(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void syr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
          cl::sycl::buffer<float, 1> &x, std::int64_t incx, cl::sycl::buffer<float, 1> &y,
...
void syr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void ger(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n, float alpha,
         cl::sycl::buffer<float, 1> &x, std::int64_t incx, cl::sycl::buffer<float, 1> &y,
         std::int64_t incy, cl::sycl::buffer<float, 1> &a, std::int64_t lda) {
...
void ger(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n, double alpha,
         cl::sycl::buffer<double, 1> &x, std::int64_t incx, cl::sycl::buffer<double, 1> &y,
...
void dotu(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
...
void hemm(backend_selector<backend::rocblas> selector, side left_right, uplo upper_lower,
...
void hpr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
          std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          cl::sycl::buffer<std::complex<float>, 1> &a) {
...
void gbmv(backend_selector<backend::rocblas> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y,
                      incy);
    oneapi::mkl::blas::rocblas::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda,
                                           x, incx, beta, y, incy);
...
void symm(backend_selector<backend::rocblas> selector, side left_right, uplo upper_lower,
...
void dotc(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          cl::sycl::buffer<std::complex<float>, 1> &result) {
...
void syr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
         cl::sycl::buffer<float, 1> &x, std::int64_t incx, cl::sycl::buffer<float, 1> &a,
         std::int64_t lda) {
...
void syr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, double alpha,
         cl::sycl::buffer<double, 1> &x, std::int64_t incx, cl::sycl::buffer<double, 1> &a,
         std::int64_t lda) {
    syr_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
    oneapi::mkl::blas::rocblas::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
...
void copy(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
          std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
...
void copy(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<double, 1> &x, std::int64_t incx, cl::sycl::buffer<double, 1> &y,
          std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::blas::rocblas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
...
void copy_batch(backend_selector<backend::rocblas> selector, std::int64_t n,
                cl::sycl::buffer<float, 1> &x, std::int64_t incx, std::int64_t stridex,
                cl::sycl::buffer<float, 1> &y, std::int64_t incy, std::int64_t stridey,
                std::int64_t batch_size) {
    copy_batch_precondition(selector.get_queue(), n, x, incx, stridex, y, incy, stridey,
                            batch_size);
    oneapi::mkl::blas::rocblas::MAJOR::copy_batch(selector.get_queue(), n, x, incx, stridex, y, incy,
                                                 stridey, batch_size);
...
void hemv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
          std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx, std::complex<float> beta,
          cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy) {
...
void gemmt(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose transa,
    ...
    gemmt_precondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b,
                       ldb, beta, c, ldc);
    oneapi::mkl::blas::rocblas::MAJOR::gemmt(selector.get_queue(), upper_lower, transa, transb, n, k,
                                            alpha, a, lda, b, ldb, beta, c, ldc);
...
void asum(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
          cl::sycl::buffer<float, 1> &result) {
...
void asum(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
          std::int64_t incx, cl::sycl::buffer<float, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::blas::rocblas::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void sbmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
void spr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
          cl::sycl::buffer<float, 1> &x, std::int64_t incx, cl::sycl::buffer<float, 1> &y,
...
void spr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
          double alpha, cl::sycl::buffer<double, 1> &x, std::int64_t incx,
          cl::sycl::buffer<double, 1> &y, std::int64_t incy, cl::sycl::buffer<double, 1> &a) {
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
    oneapi::mkl::blas::rocblas::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
...
void iamax(backend_selector<backend::rocblas> selector, std::int64_t n,
           cl::sycl::buffer<float, 1> &x, std::int64_t incx,
           cl::sycl::buffer<std::int64_t, 1> &result) {
...
void rotm(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
          std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
          cl::sycl::buffer<float, 1> &param) {
...
void rotm(backend_selector<backend::rocblas> selector, std::int64_t n,
          cl::sycl::buffer<double, 1> &x, std::int64_t incx, cl::sycl::buffer<double, 1> &y,
...
void dot(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
         std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
         cl::sycl::buffer<float, 1> &result) {
...
void dot(backend_selector<backend::rocblas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void symv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n, float alpha,
          cl::sycl::buffer<float, 1> &a, std::int64_t lda, cl::sycl::buffer<float, 1> &x,
          std::int64_t incx, float beta, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
...
void symv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event syr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event scal(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
cl::sycl::event scal(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
cl::sycl::event scal(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event trmv(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
    ...
    trmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::trmv(selector.get_queue(), upper_lower, trans,
...
cl::sycl::event spr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event hpmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event her2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event hbmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event rot(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event rot(backend_selector<backend::rocblas> selector, std::int64_t n, float *x,
...
cl::sycl::event rot(backend_selector<backend::rocblas> selector, std::int64_t n, double *x,
...
cl::sycl::event axpy(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
cl::sycl::event axpy(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
cl::sycl::event axpy(backend_selector<backend::rocblas> selector, std::int64_t n,
                     std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
                     std::complex<float> *y, std::int64_t incy,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    axpy_precondition(selector.get_queue(), n, alpha, x, incx, y, incy, dependencies);
...
cl::sycl::event axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t *n,
...
cl::sycl::event axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
cl::sycl::event axpy_batch(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
cl::sycl::event axpby(backend_selector<backend::rocblas> selector, std::int64_t n, float alpha,
...
cl::sycl::event axpby(backend_selector<backend::rocblas> selector, std::int64_t n, double alpha,
...
cl::sycl::event axpby(backend_selector<backend::rocblas> selector, std::int64_t n,
                      std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
...
cl::sycl::event gerc(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n,
                     std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
                     const std::complex<float> *y, std::int64_t incy, std::complex<float> *a,
                     std::int64_t lda,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event syr2k(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
                      std::int64_t n, std::int64_t k, float alpha, const float *a, std::int64_t lda,
...
cl::sycl::event gemv(backend_selector<backend::rocblas> selector, transpose trans, std::int64_t m,
...
cl::sycl::event gemv_batch(backend_selector<backend::rocblas> selector, transpose *trans,
    ...
    auto done = oneapi::mkl::blas::rocblas::MAJOR::gemv_batch(selector.get_queue(), trans, m, n,
...
cl::sycl::event dgmm_batch(backend_selector<backend::rocblas> selector, side *left_right,
    ...
    dgmm_batch_precondition(selector.get_queue(), left_right, m, n, a, lda, x, incx, c, ldc,
                            group_count, group_size, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::dgmm_batch(selector.get_queue(), left_right, m, n,
...
cl::sycl::event her(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event hpr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
                    float alpha, const std::complex<float> *x, std::int64_t incx,
                    std::complex<float> *a,
                    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event iamin(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
...
cl::sycl::event iamin(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
                      std::int64_t incx, std::int64_t *result,
                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::iamin(selector.get_queue(), n, x, incx, result,
...
cl::sycl::event iamin(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event spmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event swap(backend_selector<backend::rocblas> selector, std::int64_t n, float *x,
...
cl::sycl::event swap(backend_selector<backend::rocblas> selector, std::int64_t n, double *x,
...
cl::sycl::event swap(backend_selector<backend::rocblas> selector, std::int64_t n,
                     std::complex<float> *x, std::int64_t incx, std::complex<float> *y,
                     std::int64_t incy,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event geru(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n,
                     std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
                     const std::complex<float> *y, std::int64_t incy, std::complex<float> *a,
                     std::int64_t lda,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event nrm2(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event nrm2(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
...
cl::sycl::event nrm2(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
...
cl::sycl::event gemm(backend_selector<backend::rocblas> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c,
                      ldc, dependencies);
    auto done =
        oneapi::mkl::blas::rocblas::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha,
...
cl::sycl::event ger(backend_selector<backend::rocblas> selector, std::int64_t m, std::int64_t n,
                    float alpha, const float *x, std::int64_t incx, const float *y,
                    std::int64_t incy, float *a, std::int64_t lda,
                    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    ger_precondition(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y,
...
cl::sycl::event dotu(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event hpr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
                     std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
                     const std::complex<float> *y, std::int64_t incy, std::complex<float> *a,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    hpr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a,
...
cl::sycl::event gbmv(backend_selector<backend::rocblas> selector, transpose trans, std::int64_t m,
...
cl::sycl::event dotc(backend_selector<backend::rocblas> selector, std::int64_t n,
                     const std::complex<float> *x, std::int64_t incx, const std::complex<float> *y,
                     std::int64_t incy, std::complex<float> *result,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event syr(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event rotmg(backend_selector<backend::rocblas> selector, float *d1, float *d2, float *x1,
    ...
    auto done = oneapi::mkl::blas::rocblas::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param,
                                                        dependencies);
...
cl::sycl::event trsv(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
    ...
    trsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::trsv(selector.get_queue(), upper_lower, trans,
                                                       unit_diag, n, a, lda, x, incx, dependencies);
    trsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                       dependencies);
    return done;
...
cl::sycl::event copy(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
                     std::int64_t incx, float *y, std::int64_t incy,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event copy(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
                     std::int64_t incx, double *y, std::int64_t incy,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy,
...
cl::sycl::event copy(backend_selector<backend::rocblas> selector, std::int64_t n,
...
cl::sycl::event copy_batch(backend_selector<backend::rocblas> selector, std::int64_t *n,
                           const float **x, std::int64_t *incx, float **y, std::int64_t *incy,
                           std::int64_t group_count, std::int64_t *group_size,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event hemv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
                     std::complex<float> alpha, const std::complex<float> *a, std::int64_t lda,
                     const std::complex<float> *x, std::int64_t incx, std::complex<float> beta,
                     std::complex<float> *y, std::int64_t incy,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event sbmv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
...
cl::sycl::event asum(backend_selector<backend::rocblas> selector, std::int64_t n,
                     const std::complex<float> *x, std::int64_t incx, float *result,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event asum(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
                     std::int64_t incx, float *result,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    asum_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::asum(selector.get_queue(), n, x, incx, result,
...
cl::sycl::event asum(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
                     std::int64_t incx, double *result,
                     const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    asum_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::asum(selector.get_queue(), n, x, incx, result,
...
cl::sycl::event spr2(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
                     float alpha, const float *x, std::int64_t incx, const float *y,
...
cl::sycl::event iamax(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
                      std::int64_t incx, std::int64_t *result,
                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
...
cl::sycl::event iamax(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
                      std::int64_t incx, std::int64_t *result,
                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamax_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::iamax(selector.get_queue(), n, x, incx, result,
...
cl::sycl::event iamax(backend_selector<backend::rocblas> selector, std::int64_t n,
                      const std::complex<float> *x, std::int64_t incx, std::int64_t *result,
                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamax_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::blas::rocblas::MAJOR::iamax(selector.get_queue(), n, x, incx, result,
...
cl::sycl::event rotm(backend_selector<backend::rocblas> selector, std::int64_t n, float *x,
...
cl::sycl::event rotm(backend_selector<backend::rocblas> selector, std::int64_t n, double *x,
...
cl::sycl::event sdsdot(backend_selector<backend::rocblas> selector, std::int64_t n, float sb,
...
cl::sycl::event her2k(backend_selector<backend::rocblas> selector, uplo upper_lower, transpose trans,
                      std::int64_t n, std::int64_t k, std::complex<float> alpha,
                      const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
...
cl::sycl::event dot(backend_selector<backend::rocblas> selector, std::int64_t n, const float *x,
...
cl::sycl::event dot(backend_selector<backend::rocblas> selector, std::int64_t n, const double *x,
...
cl::sycl::event symv(backend_selector<backend::rocblas> selector, uplo upper_lower, std::int64_t n,
